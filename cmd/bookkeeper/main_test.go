...
func Test_getNearestAccountingDate(t *testing.T) {
	...
	var tests = []struct {
		...
		// if custom period is not set, then we use default 1st of April (the start of financial year)
		{"", dateOf("01-06-2019"), dateOf("01-04-2019"), false},
		{"", dateOf("01-02-2019"), dateOf("01-04-2018"), false},
